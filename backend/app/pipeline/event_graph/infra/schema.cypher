CREATE CONSTRAINT eg_fatto_id            IF NOT EXISTS FOR (e:Fatto)           REQUIRE e.id IS UNIQUE;
...
CREATE INDEX eg_fatto_doc            IF NOT EXISTS FOR (e:Fatto)           ON (e.documento);
CREATE INDEX eg_fatto_lemma          IF NOT EXISTS FOR (e:Fatto)           ON (e.lemma);
CREATE INDEX eg_fatto_piano          IF NOT EXISTS FOR (e:Fatto)           ON (e.piano);
CREATE INDEX eg_fatto_posizione      IF NOT EXISTS FOR (e:Fatto)           ON (e.posizione_doc, e.posizione_chunk);
CREATE INDEX eg_fatto_tempo_abs      IF NOT EXISTS FOR (e:Fatto)           ON (e.tempo_assoluto);
CREATE INDEX eg_fatto_catena         IF NOT EXISTS FOR (e:Fatto)           ON (e.catena_id);
...
CREATE FULLTEXT INDEX eg_fatto_testo IF NOT EXISTS FOR (e:Fatto) ON EACH [e.lemma, e.ancora];
